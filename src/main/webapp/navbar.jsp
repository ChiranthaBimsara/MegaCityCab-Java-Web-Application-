    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto"> <!-- ms-auto aligns navbar to the right -->
                ...
                <li class="nav-item">
                    <a class="nav-link" href="booking_details.jsp"><i class="fas fa-calendar-check"></i> Bookings</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="car.jsp"><i class="fas fa-car"></i> Car</a> <!-- New Car menu item -->
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="admin_profile.jsp"><i class="fas fa-user-circle"></i> Profile</a> <!-- New Car menu item -->
                </li>
                <li class="nav-item">
